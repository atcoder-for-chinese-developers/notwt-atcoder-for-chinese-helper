...
// https://cdn.bootcdn.net/ajax/libs/marked/2.0.3/marked.js
...
function writeSource() {
    if (xmlHttp.readyState == 4 && xmlHttp.status == 200 && !flg200) {
        flg200 = 1;
        ...
        for (let i = 0; i < a.length; i++){
            if (i % 2 == 1) fin += katex.renderToString(a[i])
            else fin += a[i]
        }
        fin = marked(fin)
    ...
    var del = document.getElementsByTagName('p')
    for (let i = 0; i < del.length; i++){
        if (del[i].innerText == 'undefined'){
            del[i].innerText = ''
        }
    }
...
cn.setAttribute('data-lang', 'cn')
cn.innerHTML = ' / <img src=\"//img.atcoder.jp/assets/flag/CN.png\">'
cn.setAttribute('onclick', 'disap()')
fl.appendChild(cn)

var cnlang = document.createElement('span')
cnlang.setAttribute('class', 'lang-cn')
...
if (!flg200){
        cnlang.innerHTML = marked('暂无中文题面，欢迎[贡献](https://github.com/atcoder-for-chinese-developers/atcoder-for-chinese)！')
        var t = document.getElementsByClassName('lang')
        t[0].appendChild(cnlang)
}
